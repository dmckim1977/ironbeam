...
from ironbeam.info.models import SecurityDefinitionsResponse, \
    SecurityMarginAndValueResponse, TraderInfo, UserInfo
...
class Info:
    ...
    def get_security_definitions(self, symbols: List[str],
                                 bearer_token: str) -> SecurityDefinitionsResponse:
        """
    ...
    def get_security_margin(self, symbols: List[str],
                            bearer_token: str) -> SecurityMarginAndValueResponse:
        """
